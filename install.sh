...
curl https://nlg-install-agent.s3.ap-southeast-1.amazonaws.com/fluentbit-config/nectec.conf -o nectec.conf
curl https://nlg-install-agent.s3.ap-southeast-1.amazonaws.com/fluentbit-config/parsers.conf -o parsers.conf

mv -t /etc/fluent-bit/ nectec.conf parsers.conf
SCRIPT
    ;;
...
#Download file config and overwrite file config fluentbit
